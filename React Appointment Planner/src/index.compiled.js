...
},{"./setPrototypeOf":2}],2:[function(require,module,exports){
...
var _ContactPicker = require("../contactPicker/ContactPicker");
...
},{"../contactPicker/ContactPicker":37,"react":undefined}],36:[function(require,module,exports){
"use strict";
...
var ContactPicker = function ContactPicker(props) {
  ...
  return /*#__PURE__*/_react["default"].createElement("select", {
    ...
    value: ""
  }, "Select a contact"), contacts.map(function (contact) {
...
var TileList = function TileList(_ref) {
  var objArr = _ref.objArr;
  return /*#__PURE__*/_react["default"].createElement("div", null, objArr.map(function (value, index) {
...
var AppointmentsPage = function AppointmentsPage(props) {
  ...
  var contacts = props.contacts;
  var addAppointment = props.addAppointment; // local States
  ...
  var handleSubmit = function handleSubmit(e) {
    ...
    addAppointment(title, contact, date, time); // reset values
...
var ContactsPage = function ContactsPage(props) {
  ...
  */
  ...
  var handleSubmit = function handleSubmit(e) {
    ...
    if (!duplicate) {
      addContact(name, phone, email); // reset values
